...
struct Constants{
    ...
    static let LargeFont : Font = Font(UIFont(name: "Bebas Neue", size: UIScreen.main.bounds.width/13) ?? UIFont.systemFont(ofSize: 13))
    static let HomeFont : Font = Font(UIFont(name: "Bebas Neue", size: UIScreen.main.bounds.width/15) ?? UIFont.systemFont(ofSize: 13))
